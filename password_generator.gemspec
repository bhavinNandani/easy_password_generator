...
Gem::Specification.new do |spec|
  ...
  spec.summary = "A Simple Password generator Gem."
  spec.description = "Provides simple and customizable way to generate the password"
  ...
  spec.add_development_dependency "byebug", "~> 11.0" # Add this line
